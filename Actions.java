...
public class Actions {
    ...
    public void takeRole(Player player, String roleName) {
        ...
        if (validateTakeRole(player, choice)) {
            ...
            choice.setAssignnedPlayer(player);
...
//clear roles before removing scene 
        ...
        for (Role role : allRoles) {
            Player player = role.getAssignnedPlayer();
            if (player != null) {
                player.leaveRole();
    ...
    public void payOut(Room room, Scene scene) {
        ...
        if (!starringRoles.isEmpty() && onCard) {
            ...
            for (int i = 0; i < budget; i++) {
                ...
                Player p = role.getAssignnedPlayer();
                if (p != null) {
